...
\end{tabular}
\caption{Scope of our tool for suggesting triggers only based on the rule script (no triggers written by the user). High indicates that all the suggestions are useful, medium indicates that it only the event-based suggestions are useful and none indicates that none of the suggestions are useful. }
\label{tab:scope1}
\end{table}
