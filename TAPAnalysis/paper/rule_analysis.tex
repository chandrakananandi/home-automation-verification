...
\begin{figure}
\centering
\includegraphics [trim=3cm 2cm 0 5cm, scale=0.4]{images/framework.png}
...
\emph{Definition}. Errors due to too few triggers is a condition where an insufficient number of triggers leads to fewer firing of a rule thereby leading to unexpected behavior.
...
We evaluated our tool on 116 end user written rules. \todo{how much time did it take to run all the experiments? create a table with all rule names, number of triggers suggested}
...
\section{Conclusions}
End users have a major role in home automation--they decide the automation rules for their own homes. Not surprisingly, our research shows that these end user written rules \textit{are} a major source of security vulnerability in smart homes. 
...
We thank Franziska Roesner for her feedback and comments and Jeanette Daum for contributing to an earlier version of this project.
