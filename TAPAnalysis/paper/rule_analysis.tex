...
We implemented the automatic trigger generator in Java. It involved $\sim$ 3000 LOC. Our tool can be used directly on a rule file without any pre-processing of the rules.   \todo{[not sure how much details need to go here, I could talk forever on this]} 
