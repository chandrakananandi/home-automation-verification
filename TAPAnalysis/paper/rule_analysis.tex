...
For 109 out of the 116 rules, TrigGen suggested a list of all required event-based triggers and for 77 out the 116 rules, it found missing triggers when some triggers were already provide by the users. For 19 rules, TrigGen generated warnings about potential conflicts. 
...
\begin{figure*}[t]
\centering
\includegraphics [trim=1.5cm 0 50 20, scale=0.7]{images/resultgraph.png}
