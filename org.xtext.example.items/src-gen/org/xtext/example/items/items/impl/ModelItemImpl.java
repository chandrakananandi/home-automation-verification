...
import org.xtext.example.items.items.ModelItem;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.items.items.impl.ModelItemImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.example.items.items.impl.ModelItemImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link org.xtext.example.items.items.impl.ModelItemImpl#getIcon <em>Icon</em>}</li>
 *   <li>{@link org.xtext.example.items.items.impl.ModelItemImpl#getGroups <em>Groups</em>}</li>
 *   <li>{@link org.xtext.example.items.items.impl.ModelItemImpl#getBindings <em>Bindings</em>}</li>
 *   <li>{@link org.xtext.example.items.items.impl.ModelItemImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
