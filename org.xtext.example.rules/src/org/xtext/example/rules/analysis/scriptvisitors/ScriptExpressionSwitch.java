...
public class ScriptExpressionSwitch extends ScriptSwitch<Boolean>{
	public Boolean caseXExpression(XExpression object){
		...
		case("XAbstractWhileExpressionImpl"):
			XAbstractWhileExpression whileExpression=new XAbstractWhileExpression((XAbstractWhileExpressionImpl)object);
		...
		case("XBasicForLoopExpressionImpl"):
			XBasicForLoopExpression xBasicForLoopExpression = new XBasicForLoopExpression((XBasicForLoopExpressionImpl)object);
		...
		case("XBinaryOperationImplCustom"):
			XBinaryOperationCustom xbinaryOperationCustom=new XBinaryOperationCustom((XBinaryOperationImplCustom)object);
		...
		case("XBlockExpressionImplCustom"):
			XBlockExpressionCustom xBlockExpressionCustom= new XBlockExpressionCustom((XBlockExpressionImplCustom)object);
		...
		case("XMemberFeatureCallImplCustom"):
			XMemberFeatureCallCustom xMemberFeatureCallCustom = new XMemberFeatureCallCustom((XMemberFeatureCallImplCustom)object);
		...
		case("XSynchronizedExpressionImpl"):
			XSynchronizedExpression xSynchronizedExpression=new XSynchronizedExpression((XSynchronizedExpressionImpl)object);	
		...
		case("XTryCatchFinallyExpressionImpl"):
			XTryCatchFinallyExpression xTryCatchFinallyExpression=new XTryCatchFinallyExpression((XTryCatchFinallyExpressionImpl)object);
