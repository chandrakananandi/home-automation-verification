            	...
            	case 1 :
            	    ...
            	    state._fsp--;
            	    					...
            	    					add(
            	    						...
            	    						"strategies",
            	    						lv_strategies_3_0,
            	    						"org.xtext.example.persistence.Persistence.Strategy");
                    	...
                    	case 1 :
                    	    ...
                    	    state._fsp--;
                    	    						...
                    	    						add(
                    	    							...
                    	    							"filters",
                    	    							lv_filters_12_0,
                    	    							"org.xtext.example.persistence.Persistence.Filter");
                    	    						afterParserOrEnumRuleCall();
                    	...
                    	case 1 :
                    	    ...
                    	    state._fsp--;
                    	    						...
                    	    						add(
                    	    							...
                    	    							"configs",
                    	    							lv_configs_16_0,
                    	    							"org.xtext.example.persistence.Persistence.PersistenceConfiguration");
                    	    						afterParserOrEnumRuleCall();
        ...
        try {
            ...
            state._fsp--;
            					...
            					set(
            						...
            						"definition",
            						lv_definition_2_0,
            						"org.xtext.example.persistence.Persistence.FilterDetails");
            					afterParserOrEnumRuleCall();
        ...
        try {
            ...
            state._fsp--;
            					...
            					set(
            						...
            						"value",
            						lv_value_1_0,
            						"org.xtext.example.persistence.Persistence.DECIMAL");
            					afterParserOrEnumRuleCall();
                ...
                case 1 :
                    ...
                    state._fsp--;
                    						...
                    						add(
                    							...
                    							"items",
                    							lv_items_0_1,
                    							"org.xtext.example.persistence.Persistence.AllConfig");
                    						afterParserOrEnumRuleCall();
                ...
                case 2 :
                    ...
                    state._fsp--;
                    						...
                    						add(
                    							...
                    							"items",
                    							lv_items_0_2,
                    							"org.xtext.example.persistence.Persistence.ItemConfig");
                    						afterParserOrEnumRuleCall();
                ...
                case 3 :
                    ...
                    state._fsp--;
                    						...
                    						add(
                    							...
                    							"items",
                    							lv_items_0_3,
                    							"org.xtext.example.persistence.Persistence.GroupConfig");
                    						afterParserOrEnumRuleCall();
